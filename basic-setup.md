...
1. Create a Developer Portal user.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/t_getting_started_for_partners.htm#OHIPU-AddingUsers-3E28413A](Adding Developer Portal Users)
2. Assign the `ApplicationDeveloper` role to the Developer Portal user.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/t_getting_started_for_partners.htm#OHIPU-AssigningUsersToRoles-879F91FD](Assigning Users to Roles)
3. Sign in to the Oracle Hospitality Developer Portal.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/t_getting_started_for_partners.htm#OHIPU-SigningInToTheDeveloperPortal-DC32FEE5](Signing In to the Oracle Hospitality Developer Portal)

## Understanding the Developer Portal

1. Searching for the Customer Relationship Management API.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/ch_discover_and_subscribe_to_APIs.htm#OHIPU-APISearchEngine-3C569607](API Search Engine)
...
6. Create an application and subscribe it to the Property APIs.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/c_register_and_manage_applications.htm#OHIPU-CreatingAnApplication-D59E4A5D](Registering an Application).  Note down the Application Key.

## Obtaining credentials

In this lab, we are using an environment on the Resource Owner grant.

1. Create an integration user via the Shared Security Domain vendor self-registration portal.  Use the `Tenant` code supplied by the Oracle team.  Enter your company name in the `Vendor` field, without spaces and to a maximum of 10 characters.  Fill in the contact details and security questions.  Note down the `Interface ID` and `Interface Key`; these are your username and password.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/c_oracle_hospitality_property_apis.htm#OHIPU-AuthenticatingToOracleHospitalityPr-1BD54F80](Authenticating to Oracle Hospitality Property APIs)
...
3. On the Environments page add an environment, specifying your Integration Username (`Interface ID`), choosing the region and environment type listed by the Oracle team.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/t_adding_an_environment.htm](Adding an Environment)
...
1. Download the latest Postman collections and the [https://github.com/oracle/hospitality-api-docs/blob/main/postman-collections/oracle-hospitality-property.postman_environment.json](Postman Environment) from the [https://github.com/oracle/hospitality-api-docs/tree/main/postman-collections](Oracle Hospitality Github repository)
...
1. Go back to the Developer Portal and click on the Analytics tab.  See [https://docs.oracle.com/cd/F29336_01/doc.201/f27480/c_analytics.htm#OHIPU-Analytics-EC725F0D](Analytics)
